...
// UC-202
userRouter.get('', authController.validate, userController.getUserList)
...
// UC-205
userRouter.put("/:userId", authController.validate, authController.login, userController.updateUser)
// UC-206
